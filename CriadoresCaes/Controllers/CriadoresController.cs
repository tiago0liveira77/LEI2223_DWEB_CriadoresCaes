...
namespace CriadoresCaes.Controllers
{
    public class CriadoresController : Controller
    {
        ...
        {
              return _context.Criadores != null ? 
                          View(await _context.Criadores.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.Criadores'  is null.");
        }
        ...
        {
          return (_context.Criadores?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
